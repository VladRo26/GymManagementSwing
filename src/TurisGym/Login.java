...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TurisGym/Images/img3.jpg"))); // NOI18N

        jLabel3.setText("UserName");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel2.setText("TURIS GYM");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            if (rs.next()) {
                // If login is successful, open the member window
                JOptionPane.showMessageDialog(this, "Login successful!");
                new Members().setVisible(true); // Assuming you have a MemberWindow class
